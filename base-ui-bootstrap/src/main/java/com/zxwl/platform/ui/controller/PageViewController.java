...
public class PageViewController {
    ...
    @RequestMapping(value = "/api/view.html", method = RequestMethod.GET)
    ...
    public List<Module> buildMenu(String activeId) {
        ...
        Module moduleBean = moduleService.selectByPk(activeId);
        for (Module module : moduleList) {
            if(!"".equals(activeId)){
                if(moduleBean.getParentId().equals(module.getId())){
