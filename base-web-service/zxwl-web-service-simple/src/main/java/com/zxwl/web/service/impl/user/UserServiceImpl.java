...
public class UserServiceImpl extends AbstractServiceImpl<User, String> implements UserService {
    ...
    @Override
    public UserDefInfo selectUserInfo(String userId) {
        return userMapper.selectUserInfo(userId);
    }

    @Override
    public int insertWxUserRole(String id){
        UserRole wxUserRole = new UserRole();
        wxUserRole.setUserId(id);
        wxUserRole.setRoleId("user");
        InsertParam<UserRole> param = new InsertParam<>();
        param.setData(wxUserRole);
